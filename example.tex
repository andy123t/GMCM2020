...
\baominghao{\hspace{6em} 20200900001} %参赛队号
\schoolname{\hspace{5.8em} 所在学校名称}%学校名称
...
\begin{minipage}[t]{0.5\linewidth}
\centering
\includegraphics[width=\textwidth]{fig02.pdf}  % 2.2in
\caption{fig2}
\label{fig:side:b}
\end{minipage}
\end{figure}
...
\begin{figure}[!htp]
	\centering
	\subfloat[Arabic numerals]{\includegraphics[width=0.5\textwidth]{fig01.pdf}}
	\subfloat[Arabic numerals]{\includegraphics[width=0.5\textwidth]{fig02.pdf}} \\
	\subfloat[Arabic numerals]{\includegraphics[width=0.5\textwidth]{fig03.pdf}}
	\subfloat[Arabic numerals]{\includegraphics[width=0.5\textwidth]{fig04.pdf}}
